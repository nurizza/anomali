	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<ul class="nav nav-list">
						...
						<?php if(strpos($this->session->userdata('previlage'), "manageuser") > 0){ ?>
					<li>
						...
						<ul class="submenu">
							...
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_pegawai/data_user">
							...
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_pegawai/kelola_user">
									<i class="menu-icon fa fa-caret-right"></i>
									Kelola User
								</a>
					...
					<?php }else{ echo "";} ?>
					<?php if(strpos($this->session->userdata('previlage'), "managepegawai") > 0){ ?>
					<li>
						<a href="#" class="dropdown-toggle">
						...
						<ul class="submenu">
							...
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_pegawai">
									<i class="menu-icon fa fa-caret-right"></i>
									Input Pegawai
								</a>
							...
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_pegawai/data_pegawai">
									<i class="menu-icon fa fa-caret-right"></i>
									Data Pegawai
								</a>
					...
					<li>
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="<?php echo base_url();?>index.php/admin/manage_anomali">
									<i class="menu-icon fa fa-caret-right"></i>
									Input Anomali
								</a>
						...
						<b class="arrow"></b>
							<ul class="submenu">
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_anomali/anomali_gi">
									<i class="menu-icon fa fa-caret-right"></i>
									Anomali GI
								</a>
							...
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_anomali/anomali_SUTT">
									<i class="menu-icon fa fa-caret-right"></i>
									Anomali SUTT
								</a>
					...
					<?php if(strpos($this->session->userdata('previlage'), "inputhasilrapat") > 0){ ?>
					<li>
						<a href="#" class="dropdown-toggle">
						...
						<b class="arrow"></b>
							<ul class="submenu">
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_anomali/rapat_gi">
									<i class="menu-icon fa fa-caret-right"></i>
									Anomali GI
								</a>
							...
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_anomali/rapat_SUTT">
									<i class="menu-icon fa fa-caret-right"></i>
									Anomali SUTT
								</a>
							...
							<?php }else{ echo "";} ?>
							<?php if(strpos($this->session->userdata('previlage'), "handledanomali") > 0){ ?>
					<li>
						<a href="#" class="dropdown-toggle">
						...
						<ul class="submenu">
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_anomali/handled_gi">
									<i class="menu-icon fa fa-caret-right"></i>
									Anomali GI
								</a>
							...
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_anomali/handled_SUTT">
					...
					<li>
						...
						<ul class="submenu">
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_anomali/report_gi">
									<i class="menu-icon fa fa-caret-right"></i>
									Report GI
								</a>
							...
							<li >
								<a href="<?php echo base_url();?>index.php/admin/manage_anomali/report_sutt">
									<i class="menu-icon fa fa-fla"></i>
									Report SUTT
								</a>
    ...
    <script src="<?php echo base_url();?>assets/admin/js/pages/tables/jquery-datatable.js"></script>
		<script type="text/javascript">
			function getbase(val) {
				$.ajax({
					url: '<?php echo base_url(); ?>index.php/admin/manage_anomali/getgardu',
					type: 'POST',
					dataType: 'html',
					data: "param="+val,
					success: function(r) {
			...
			function getopt(val) {
				var data = $("#gi").val();
				$.ajax({
					url: '<?php echo base_url(); ?>index.php/admin/manage_anomali/getopt',
					type: 'POST',
					dataType: 'html',
			...
			function gettipe(data) {
				var id = $("#lokasi").val();
				$.ajax({
					url: '<?php echo base_url(); ?>index.php/admin/manage_anomali/gettype',
					type: 'POST',
					dataType: 'html',
