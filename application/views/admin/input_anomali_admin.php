					...
					<div class="page-content">
						...
						<div class="row">
							...
							<?php endif ?>
								...
								<form class="form-horizontal" enctype='multipart/form-data' role="form" method="post" id="add_user" action="<?php echo base_url();?>index.php/admin/manage_anomali/simpan/">
