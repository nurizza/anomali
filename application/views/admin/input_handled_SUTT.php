					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-offset-3 col-md-6">
								...
								<form class="form-horizontal" role="form" method="post" id="add_user" action="<?php echo base_url();?>index.php/admin/manage_anomali/updates_handled_anomali_SUTT/">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="input-group">
																	<input class="form-control date-picker" id="id-date-picker-1" placeholder="Tanggal Temuan" type="text" data-date-format="dd-mm-yyyy" name="tanggal_penanganan" value="<?php echo $key->tanggal_penanganan; ?>" />
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="no_ba" id="form-field-1" placeholder="No Berita Acara" class="col-xs-10 col-sm-12" value="<?php echo $key->no_ba; ?>" />
										</div>
									</div>
