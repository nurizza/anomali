					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-offset-3 col-md-6">
								...
								<form class="form-horizontal" role="form" method="post" id="add_user" action="<?php echo base_url();?>index.php/admin/manage_anomali/updates_handled_anomali/">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input required required  type="text" name="prev_no" id="form-field-1" placeholder="Basacamp" class="col-xs-10 col-sm-12" disabled="true" value="<?php echo $key->nama_bc; ?>" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input required required  type="text" name="nama_lengkap" id="form-field-1" disabled="true" placeholder="Nama Lengkap" class="col-xs-10 col-sm-12" value="<?php echo $key->nama_gi; ?>" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input required required  type="text" name="posisi_lengkap" id="form-field-1" disabled="true" placeholder="Posisi Lengkap" class="col-xs-10 col-sm-12" value="<?php echo $key->penghantar; ?>" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input required required  type="text" name="email" id="form-field-1" placeholder="Email" disabled="true" class="col-xs-10 col-sm-12" value="<?php echo $key->kategori; ?>" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input required required  type="text" name="password" id="form-field-1" disabled="true" placeholder="Password" class="col-xs-10 col-sm-12" value="<?php echo $key->alat; ?>" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input required required  type="text" name="password" id="form-field-1" disabled="true" placeholder="Password" class="col-xs-10 col-sm-12" value="<?php echo $key->nama_jenis; ?>" />
										</div>
									</div>
									...
									<div class="col-md-9">
									<input required required  class="form-control" disabled="true" data-date-format="dd-mm-yyyy"  type="text"  name="rencana_penanganan" value="<?php echo $key->rencana_penanganan; ?>" id="id-date-range-picker-1" />
