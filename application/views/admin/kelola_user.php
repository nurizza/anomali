												...
												<tr>
													...
													<td class="center">
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="<?php echo base_url(); ?>index.php/admin/manage_pegawai/aktivasi/Aktif/<?php echo $data['id']; ?>" class="btn btn-xs btn-info">
																<i class="fa fa-check-circle" aria-hidden="true" value="active"></i> Active
															</a>
															&nbsp;
															<a href="<?php echo base_url(); ?>index.php/admin/manage_pegawai/aktivasi/Nonaktif/<?php echo $data['id']; ?>" class="btn btn-xs btn-danger">
