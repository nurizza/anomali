...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Pegawai-Anomali App</title>
...
<ul class="nav nav-list">
					...
					<?php if(strpos($this->session->userdata('previlage'), "datapegawai") > 0){ ?>
					<li >
						<a href="<?php echo base_url();?>index.php/user/manage_anomali/data_pegawai">
					...
					<li>
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo base_url();?>index.php/user/manage_anomali">
						...
						<b class="arrow"></b>
							<ul class="submenu">
							<li >
								<a href="<?php echo base_url();?>index.php/user/manage_anomali/anomali_gi">
									<i class="menu-icon fa fa-caret-right"></i>
									Anomali GI
								</a>
							...
							<li >
								<a href="<?php echo base_url();?>index.php/user/manage_anomali/anomali_SUTT">
									<i class="menu-icon fa fa-caret-right"></i>
									Data Anomali SUTT
								</a>
					...
					<li>
						...
						<b class="arrow"></b>
							<ul class="submenu">
							<li >
								<a href="<?php echo base_url();?>index.php/user/manage_anomali/rapat_gi">
									<i class="menu-icon fa fa-caret-right"></i>
									Anomali GI
								</a>
							...
							<li >
								<a href="<?php echo base_url();?>index.php/user/manage_anomali/rapat_SUTT">
									<i class="menu-icon fa fa-caret-right"></i>
									Anomali SUTT
								</a>
					...
					<li>
						...
						<ul class="submenu">
							<li >
								<a href="<?php echo base_url();?>index.php/user/manage_anomali/handled_gi">
									<i class="menu-icon fa fa-caret-right"></i>
									Anomali GI
								</a>
							...
							<li >
								<a href="<?php echo base_url();?>index.php/user/manage_anomali/handled_SUTT">
					...
					<li>
						...
						<ul class="submenu">
							<li >
								<a href="<?php echo base_url();?>index.php/user/manage_anomali/report_gi">
									<i class="menu-icon fa fa-caret-right"></i>
									Report GI
								</a>
							...
							<li >
								<a href="<?php echo base_url();?>index.php/user/manage_anomali/report_sutt">
									<i class="menu-icon fa fa-fla"></i>
									Report SUTT
								</a>
