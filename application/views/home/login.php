...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login Page-Anomali App</title>
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<span style="color: green;"><i class="fa fa-bar-chart" aria-hidden="true"></i></span>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="<?php echo base_url('index.php/user/auth/login')?>" method="post">
												<fieldset>
												<div></div>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="prev_no"  class="form-control" placeholder="Username" required>
