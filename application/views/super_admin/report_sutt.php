												...
												<tr>
													...
													<td class="center">
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="<?php echo base_url(); ?>index.php/super_admin/manage_anomali/ubah_report_sutt/<?php echo $data['id_anomali']; ?>" class="btn btn-xs btn-info">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</a>

															<a href="<?php echo base_url(); ?>index.php/super_admin/manage_anomali/hapus_anomali_report_sutt/<?php echo $data['id_anomali']; ?>" class="btn btn-xs btn-danger">
