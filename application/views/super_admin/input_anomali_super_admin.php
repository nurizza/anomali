					...
					<div class="page-content">
						...
						<div class="row">
							...
							<?php endif ?>
								...
								<form class="form-horizontal" enctype='multipart/form-data' role="form" method="post" id="add_user" action="<?php echo base_url();?>index.php/super_admin/manage_anomali/simpan/" >
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Tanggal Temuan</label>
										<div class="col-md-9">
											<div class="input-group">
																	<input required class="form-control date-picker" id="id-date-picker-1" placeholder="Tanggal Temuan" type="text" data-date-format="dd-mm-yyyy" name="tanggal_temuan" />
