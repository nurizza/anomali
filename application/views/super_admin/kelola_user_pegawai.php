										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td class="center">
													<form action="<?php echo base_url('index.php/super_admin/manage_pegawai/simpan_privilage')?>" method="post">
													...
													<td class="center">
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="<?php echo base_url(); ?>index.php/super_admin/manage_user/aktivasi_pegawai/Aktif/<?php echo $data['id']; ?>" class="btn btn-xs btn-info">
																<i class="fa fa-check-circle" aria-hidden="true" value="active"></i> Active
															</a>
															&nbsp;
															<a href="<?php echo base_url(); ?>index.php/super_admin/manage_user/aktivasi_pegawai/Nonaktif/<?php echo $data['id']; ?>" class="btn btn-xs btn-danger">
