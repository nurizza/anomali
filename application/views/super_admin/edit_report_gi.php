					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-offset-3 col-md-6">
								...
								<form class="form-horizontal" role="form" method="post" id="add_user" action="<?php echo base_url();?>index.php/super_admin/manage_anomali/updates_report_gi/">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input required type="text" name="nama_lengkap" id="form-field-1" disabled="true" placeholder="Nama Lengkap" class="col-xs-10 col-sm-12" value="<?php echo $key->nama_bc; ?>" >
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
									...
									<div class="col-md-9">
									<input required class="form-control" data-date-format="dd-mm-yyyy"  type="text"  name="rencana_penanganan" value="<?php echo $key->rencana_penanganan; ?>" id="id-date-range-picker-1" />
								 	...
								 	<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="form-field-11" class="autosize-transition form-control" name="keterangan" value=""><?php echo $key->keterangan; ?></textarea>
										</div>
									</div>
									<div class="form-group">
