					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-offset-3 col-md-6">
								...
								<form class="form-horizontal" role="form" method="post" id="add_user" action="<?php echo base_url();?>index.php/super_admin/manage_anomali/updates_anomali/">
									...
									<label class="col-sm-3 control-label no-padding-right" for="id-date-range-picker-1">Range Handled</label>
															<div class="col-md-9">
																<div class="input-group">
																	...
																	<input required class="form-control" data-date-format="dd-mm-yyyy"  type="text" placeholder="Tanggal Perkiraan" name="rencana_penanganan" value="<?php echo $key->rencana_penanganan; ?>" id="id-date-range-picker-1" />
																</div>
															</div>
									</div>
								 	<div class="form-group">
										...
										<div class="col-md-9">
											<textarea required placeholder="Detail Anomali" id="form-field-11" class="autosize-transition form-control" name="keterangan" value=""><?php echo $key->keterangan; ?></textarea>
										</div>
									</div>
