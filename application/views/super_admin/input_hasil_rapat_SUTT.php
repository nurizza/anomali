					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-offset-3 col-md-6">
								...
								<form class="form-horizontal" role="form" method="post" id="add_user" action="<?php echo base_url();?>index.php/super_admin/manage_anomali/updates_anomali_SUTT/">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Detai Anomali </label>
										<div class="col-md-9">
									...
									<label class="col-sm-3 control-label no-padding-right" for="id-date-range-picker-1">Range Handled</label>
								 	...
								 	<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pelakasana </label>
										<div class="col-md-9">
